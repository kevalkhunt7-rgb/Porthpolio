...
const projects = [
  {
    ...
    site_url: "https://medique-51kbt2gib-kevalkhunt7-5969s-projects.vercel.app/",
  },
  {
    title: "ShopMe",
  ...
  {
    title: "ShowFlix",
    desc: "ShowFlix is a modern, full-stack movie ticket booking platform designed to deliver a smooth and cinematic experience for users. Built using the MERN stack, it allows users to explore the latest movies, watch trailers, view detailed information, and book tickets in real time.",
    image: showFlix,
    tags: ["React", "Node.js", "MongoDB"],
    titleColor: "text-purple-400",
    tagBorder: "border-slate-600 text-slate-300 hover:border-purple-400",
    ...
    cardBorder: "border-purple-500/50 hover:border-purple-400/70",
    glow: "hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] shadow-[0_0_20px_rgba(168,85,247,0.08)]",
    site_url: "https://movie-ticket-puce-one.vercel.app/",
  },
];
            ...
            >
              ...
              <div className="flex flex-col gap-3 p-4 sm:p-5 flex-1">
                ...
                <a href="https://github.com/kevalkhunt7-rgb/Medique"> <button
                  ...
                  <a href={project.site_url}><button
